...
Da notare che la regola \myrule{GarbageCollection} pulisce lo store dalle variabili inutile, ma non elimina gli oggetti che non sono più referenziati da delle variabili. Per ottenere una pulizia migliore serve quindi un'ulteriore regola:
