...
Alle due ipotesi posso applicare il corollari di subject-reduction ho che $\emptyset \vdash M' : T$.
...
\textbf{Nelle note ci sono degli esercizi che possono essere chiesti all'esame}\todo{TODO}
